...
public class ReceiverTransport
{
    ...
    /*
     * This function is used to receive pkts from the sending side of the application.
    ...
    public void receiveMessage(Packet pkt)
    {
        ...
        if( expected < pkt.getSeqnum() ){
            ...
            // In order packet.
            if (usingTCP) {
                // Check to see if the next packet was buffered already to ack the latest buffered packet.
